...
def build_from_aifdb(aifdb_config:AIFDBConfig, export_path: Optional[str] = None, debug_size: Optional[int] = None):
    """
...
def moral_maze(export_path: Optional[str] = None, debug_size: Optional[int] = None):
    ...
    build_from_aifdb(aifdb_config=moral_maze_config, export_path=export_path, debug_size=debug_size)
...
def vacc_itc(export_path: Optional[str] = None, debug_size: Optional[int] = None):
    ...
    build_from_aifdb(aifdb_config=vacc_itc_config, export_path=export_path, debug_size=debug_size)
...
def us2016(export_path: Optional[str] = None, debug_size: Optional[int] = None):
    ...
    build_from_aifdb(aifdb_config=us2016_config, export_path=export_path, debug_size=debug_size)
